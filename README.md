...
| アプリ構造 | 単一ファイル（app.py） | Blueprint 分割（auth / webhook / api_items / api_categories） |
...
| 2 | ~~**app.py の Blueprint 分割**~~ | ✅ 実装済み — `blueprints/` に auth・webhook・api_items・api_categories を分離 |
